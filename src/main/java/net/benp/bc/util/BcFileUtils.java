...
public class BcFileUtils {
    ...
    /**
     * This is used if you have a collection of non String objects and want to compare them.
     *  It's an easy way to just cast the whole Collection.
     */
    public static Collection<String> castToString(Collection<Object> objects) {

        Collection<String> result = new ArrayList<>();
        for (Object currObject : objects) {
            result.add(currObject.toString());
        }
        return result;
    }
