...
<br/>
<b>TODO:</b>
* Include a "Source Detail" for the file name or something and include that in the report.
...
<br/><br/><br/><br/><br/><br/>
<b>TODO:</b>
* Add a super simple CSV writer that can be super easily overwritten. So, it would open with a "File" and then you pass in List<String>. 
* Add a file of the Duplicates and where the blank lines are
* Add Config Builder
